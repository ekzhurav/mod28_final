from pages.authtorization_page import AuthPage
from test_data.locators import AuthtorizationLocators, RegistrationLocators, PasswordRecoveryLocators, AgrLocators, \
    SocialLocators
import pytest
from test_data import invalid_data, messages, valid_data
